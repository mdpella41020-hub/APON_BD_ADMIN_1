...
def AuToUpDaTE():
    try:
        ...
        print(f"Error fetching version from play store: {e}")
        version = "1.104.1"
    ...
    try:
        ...
        # ১ম ফাইল থেকে নেওয়া সঠিক ওয়ার্কিং ব্যাকআপ (OB51 এবং সঠিক হোস্টিং)
        return "https://clientbp.common.ggbluefox.com", "OB51", version
...
def GeT_Name(uid , Token):
    tok_val = Token if Token else GeTToK()
    ...
    headers = {
        ...
        'Content-Type': 'application/x-www-form-urlencoded',
        'X-GA': 'v1 1',
        'Authorization': f'Bearer {tok_val}',
        'Content-Length': '16',
